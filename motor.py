...
SyncForwardR = 0.99    # the right motor's sync coefficient when it moves forward
SyncBackwardR = 0.99   # the right motor's sync coefficient when it moves backward
